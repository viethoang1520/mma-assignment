  ...
  return (
    <ScrollView >
      ...
      <View style={{ paddingHorizontal: 20, paddingTop: 6 }} >
        <Text style={{ fontWeight: '500', fontSize: 20, paddingBottom: 20 }}>Reviews ({player?.feedbacks.length})</Text>
        {/* <Text style={{ fontWeight: '500', fontSize: 20 }}>{ player?.feedbacks[0].rating}</Text> */}
        {player?.feedbacks.map((feedback) => (
          <View>
